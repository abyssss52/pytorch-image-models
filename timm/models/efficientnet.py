...
class EfficientNet(nn.Module):
    ...
    def as_sequential(self):
        ...
        layers.extend(self.final_layers)
        layers.extend([self.global_pool, nn.Dropout(self.drop_rate), self.classifier])
        # layers.extend([self.global_pool, nn.Flatten(), nn.Dropout(self.drop_rate), self.classifier])
...
def mobilenetv2_050(pretrained=False, **kwargs):
    """ MobileNet V2 w/ 0.50 channel multiplier """
